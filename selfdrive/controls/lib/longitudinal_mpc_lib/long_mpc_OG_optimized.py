...
X_EGO_COST = 1.0  # Increased for better distance tracking
V_EGO_COST = 1.0  # Moderate weight on ego velocity
A_EGO_COST = 0.5  # Small penalty on acceleration to smooth profile
J_EGO_COST = 3.0  # Reduce jerk penalty to allow more responsiveness
A_CHANGE_COST = 150.  # Reduce to allow more acceleration freedom
DANGER_ZONE_COST = 100.
CRASH_DISTANCE = .25
LEAD_DANGER_FACTOR = 0.75
LIMIT_COST = 1e6
NUMERIC_EPS = 1e-4  # Small epsilon to avoid division-by-zero or instability
...
N = 12
MAX_T = 10.0
# Adaptive prediction horizon based on N and MAX_T
T_IDXS_LST = np.linspace(0, MAX_T, N + 1) ** 1.2  # Emphasize short-term precision
